...
try:
    ...
    # getters - method and brackets it's a getter
    print(marge_account.get_firstname())
    print(marge_account.get_lastname())

    # properties achieve the same end as a getter - exposing the hidden data
    #  named as a noun
    # notice there are no brackets
    # reading it to print it
    print(marge_account.account_holder_name)

    # setters - using property syntax - assignment operator used
